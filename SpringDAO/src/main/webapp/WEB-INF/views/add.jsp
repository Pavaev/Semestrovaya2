...
<div class="container">
  ...
  <form:form class="form-horizontal" method="POST" commandName="complaint">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <form:input type="text" class="form-control" id="firstName" placeholder="Основной текст" path="post"/>
        <b id="warning">
    ...
    <div class="form-group">
      <form:label class="control-label col-xs-3" for="inputEmail" path="company">Название компании:</form:label>
      <div class="col-xs-9">
        <form:input type="text" class="form-control" id="inputEmail" placeholder="Название компании" path="company"/>
        <b id="warning">
