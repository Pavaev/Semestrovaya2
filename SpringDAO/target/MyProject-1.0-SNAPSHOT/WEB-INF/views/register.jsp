...
<div class="container">
    ...
    <form:form class="form-horizontal" method="POST" commandName="user">
        ...
        <div class="form-group">
            <form:label class="control-label col-xs-3" for="postalAddress" path="address">Адрес:</form:label>
            <div class="col-xs-9">
                <form:textarea rows="3" class="form-control" id="postalAddress" placeholder="Введите адрес"
                               path="address"/>
            </div>
        </div>
